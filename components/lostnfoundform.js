    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.card}>
        ...
        <TextInput
          ...
          placeholderTextColor="#666" // Darker grey for visibility
          style={styles.input}
        ...
        <Dropdown
          ...
          selectedTextStyle={styles.selectedTextStyle} // Custom style for selected text
          itemTextStyle={styles.itemTextStyle} // Custom style for dropdown items
          value={lostorfound}
...
const styles = StyleSheet.create({
  ...
  placeholderStyle: {
    color: "#333", // Dropdown placeholder
    fontSize: 15,
  },
  selectedTextStyle: {
    color: "#333", // Dropdown text after selection
    fontSize: 15,
  },
  itemTextStyle: {
    color: "#333", // Dropdown item labels
  },
  uploadBox: {
    borderWidth: 2,
    borderStyle: "dashed",
